...
kom1 = ("CYBER-COP-BANGLADESH\n \nhttps://www.facebook.com/cybercopbangladesh\n \nAUTO SHERE BOT CYBER-COP\n \n[><]")
def logo_menu():
...
\033[1;39m ┃ \x1b[1;95m[💉]😎\x1b[1;96m 𝙏𝙊𝙊𝙇𝙎 𝙉𝘼𝙈𝙀\033[1;31m : [★]  FB-AUTO-SHARE      \033[1;39m ┃
...
def login():
	os.system("clear")
	print(BANNER)
	cetak(nel(f'   {H2}        LOGIN COOKIES FIRST BRO\n\n      {H2}     [GITHUB : CYBERCOP-404]',title=f'{P2} {H2}[ {OT} WELCOME TO CYBER AUTO SHARE{H2}  ]',width=54,padding=(1,4),style='blue'))
